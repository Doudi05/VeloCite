...
public class ParserTestIvann {
    ...
    @Test
    public void testParserOK2() throws StationParserException, IOException {
        ASTNode n = parser.parse(new File(path + "stationsOK2.txt"));
        assertTrue(n instanceof ASTListeStations);
        assertEquals(1, n.getNumChildren());
        for (ASTNode n1 : n) {
            assertTrue(n1 instanceof ASTStation);
            assertEquals(4, n1.getNumChildren());
            // premier petit fils -> ASTChaine
    ...
    public void testParserError1() throws StationParserException, IOException {
        ASTNode n = parser.parse(new File(path + "badSynthax1.txt"));
        assertTrue(n instanceof ASTListeStations);
        assertEquals(1, n.getNumChildren());
        for (ASTNode n1 : n) {
            assertTrue(n1 instanceof ASTStation);
    ...
    @Test(expected = StationParserException.class)
    public void testParserError2() throws StationParserException, IOException {
        ASTNode n = parser.parse(new File(path + "badSynthax2.txt"));
        assertTrue(n instanceof ASTListeStations);
        assertEquals(1, n.getNumChildren());
        for (ASTNode n1 : n) {
            assertTrue(n1 instanceof ASTStation);
    ...
    @Test(expected = StationParserException.class)
    public void testParserError3() throws StationParserException, IOException {
        ASTNode n = parser.parse(new File(path + "badSynthax3.txt"));
        assertTrue(n instanceof ASTListeStations);
        assertEquals(1, n.getNumChildren());
        for (ASTNode n1 : n) {
            assertTrue(n1 instanceof ASTStation);
    ...
    @Test(expected = StationParserException.class)
    public void testParserError4() throws StationParserException, IOException {
        ASTNode n = parser.parse(new File(path + "badSynthax4.txt"));
        assertTrue(n instanceof ASTListeStations);
        assertEquals(1, n.getNumChildren());
        for (ASTNode n1 : n) {
            assertTrue(n1 instanceof ASTStation);
    ...
    @Test(expected = StationParserException.class)
    public void testParserError5() throws StationParserException, IOException {
        ASTNode n = parser.parse(new File(path + "badSynthax5.txt"));
        assertTrue(n instanceof ASTListeStations);
        assertEquals(1, n.getNumChildren());
        for (ASTNode n1 : n) {
            assertTrue(n1 instanceof ASTStation);
    ...
    @Test(expected = StationParserException.class)
    public void testParserError6() throws StationParserException, IOException {
        ASTNode n = parser.parse(new File(path + "badSynthax6.txt"));
        assertTrue(n instanceof ASTListeStations);
        assertEquals(1, n.getNumChildren());
        for (ASTNode n1 : n) {
            assertTrue(n1 instanceof ASTStation);
    ...
    public void testParserIOE() throws StationParserException, IOException {
        ASTNode n = parser.parse(new File(path + "noExists.txt"));
        assertTrue(n instanceof ASTListeStations);
        assertEquals(1, n.getNumChildren());
        for (ASTNode n1 : n) {
            assertTrue(n1 instanceof ASTStation);
